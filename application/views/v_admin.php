<div class="content-wrapper">
    ...
    <table class="table">
            ...
            <tr>
                ...
                <td><?php echo anchor('laporan/hapus/'.$lapor->id, '<button class="btn btn-danger btn-sm"><i class="nav-icon fas fa-trash"></i></button>') ?></td>
                <td><?php echo anchor('laporan/edit/'.$lapor->id, '<button class="btn btn-primary btn-sm"><i class="nav-icon fa fa-edit" style="color:white;"></i>') ?></td>
